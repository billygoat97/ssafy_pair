...
public class HappyHouseMapController {
	...
	@GetMapping("/aptN")
	public ResponseEntity<List<HouseInfoDto>> aptN(@RequestParam("aptN") String aptN) throws Exception {
		System.out.println("hi");
		return new ResponseEntity<List<HouseInfoDto>>(happyHouseMapService.getAptInName(aptN), HttpStatus.OK);
	}
